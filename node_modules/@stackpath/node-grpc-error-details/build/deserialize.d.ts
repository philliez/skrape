...
import { RetryInfo, DebugInfo, QuotaFailure, PreconditionFailure, BadRequest, RequestInfo, ResourceInfo, Help, LocalizedMessage, ErrorInfo } from "./generated/error_details_pb";
...
export declare function deserializeGrpcStatusDetails<TMap extends Record<string, (bytes: Uint8Array) => any>>(error: ServiceError, deserializeMap: TMap): {
    status: Status;
    details: Array<ReturnType<TMap[keyof TMap]>>;
} | null;
export declare function deserializeGoogleGrpcStatusDetails(error: ServiceError): {
    status: Status;
    details: (RetryInfo | DebugInfo | QuotaFailure | ErrorInfo | PreconditionFailure | BadRequest | RequestInfo | ResourceInfo | Help | LocalizedMessage)[];
} | null;
export {};
